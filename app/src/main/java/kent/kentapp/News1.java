    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        calendarBtn.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                Intent intent = new Intent(News1.this, Calendar.class);
        ...
        computerBtn.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                Intent intent = new Intent(News1.this, FreePc.class);
                startActivity(intent);
                //finish();
            }
        });
        ...
        mapBtn.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                Intent intent = new Intent(News1.this, CampusMap.class);
                startActivity(intent);
                //finish();
            }
        });
        ...
        moreBtn.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                Intent intent = new Intent(News1.this, More.class);
                startActivity(intent);
                //finish();
            }
        });
